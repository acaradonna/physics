...
int main(){
    ...
    ape::RigidBodyDesc a{}; a.position = {0,0,0}; a.sphere_radius = 0.5f;
    ape::RigidBodyDesc b{}; b.position = {0.6f,0,0}; b.sphere_radius = 0.5f;
    w.createRigidBody(a);
    w.createRigidBody(b);
    ...
    ape::RigidBodyDesc c{}; c.position = {10,0,0}; c.sphere_radius = 0.5f;
    w.createRigidBody(c);
    w.step(0.0f);
